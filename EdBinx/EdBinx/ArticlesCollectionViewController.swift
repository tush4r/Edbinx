...
//  
//
//  Created by Tushar Sharma on 10/08/16.
//
//
...
class ArticlesCollectionViewController: UICollectionViewController, IndicatorInfoProvider {
    
    
    var item: IndicatorInfo = "Collection"
